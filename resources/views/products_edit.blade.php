...
@include('navbar');
    <div class="page" >
        ...
        <form method="POST" action=" {{route('products.update', $product->id)}} " id="invoice_add_form">
            @csrf
            @method('PUT')
                    ...
                    <div class="new_invoice_main">
                        <div class="invoice_form_row">
                            <div class="invoice_form_column_in_row" style="flex:1;">
                                ...
                                <input value="{{ $product->product_name }}" name="product_name" class="input_text" id="product_name" type="text" placeholder="Wprowadź nazwę..."/><br/>
                                ...
                                <input value="{{ $product->product_price }}" name="product_price" class="input_text" id="product_price" type="text" placeholder="Cena..."/><br/>
                                <div class="input_separator">
                                ...
                                <input value="{{ $product->producent }}" name="producent" class="input_text" id="producent" type="text" placeholder="Nazwa producenta..."/>
                                <div class="input_separator">
                                ...
                                <input value="{{ $product->product_info }}" name="product_info" class="input_text" id="product_info" type="text" placeholder="Uwagi..."/><br/>
                                <div class="input_separator">
            ...
            <div class="new_invoice">
                <button id="submit_invoice_form" type="submit" class="new_invoice_main">Zapisz produkt</div>
            </div>
        </form>
    </div>
</body>
