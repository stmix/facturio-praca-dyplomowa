                    ...
                    <div class="new_invoice_main">
                        <div class="invoice_form_row">
                            <div class="invoice_form_column_in_row" style="flex:1;">
                                ...
                                <input value="{{ old('client_name') }}" name="client_name" class="input_text" id="fullname" type="text" placeholder="Nazwa adresata..."/><br/>
                                ...
                                <input value="{{ old('client_street') }}" name="client_street" class="input_text" id="street" type="text" placeholder="Ulica..."/><br/>
                                <div class="input_separator">
                                ...
                                <input value="{{ old('client_city') }}" name="client_city" class="input_text" id="town" type="text" placeholder="Miasto"/>
                                <div class="input_separator">
                                ...
                                <input value="{{ old('client_email') }}" name="client_email" class="input_text" id="fullname" type="text" placeholder="Adres e-mail..."/><br/>
                                <div class="input_separator">
                            ...
                            <div class="invoice_form_column_in_row" style="flex:1;">
                                ...
                                <input value="{{ old('client_nip') }}" name="client_nip" class="input_text" id="phone" type="text" placeholder="NIP..."/><br/>
                                <div class="input_separator">
                                ...
                                <input value="{{ old('client_house_number') }}" name="client_house_number" class="input_text" id="number" type="text" placeholder="Nr domu..."/><br/>
                                <div class="input_separator">
                                ...
                                <input value="{{ old('client_postcode') }}" name="client_postcode" class="input_text" id="zip" type="text" placeholder="Kod pocztowy..."/>
                                <div class="input_separator">
                                ...
                                <input value="{{ old('client_phone') }}" name="client_phone" class="input_text" id="phone" type="text" placeholder="Nr telefonu..."/><br/>
                                <div class="input_separator">
